...
namespace FINALBRIGHTPROJECT.BusinessLogic
{
    public class RolesBusiness
    {
        ...
        {
            RoleManager = new RoleManager<ApplicationRole>(store: new Microsoft.AspNet.Identity.EntityFramework.RoleStore<ApplicationRole>(context: new ApplicationDbContext()));
