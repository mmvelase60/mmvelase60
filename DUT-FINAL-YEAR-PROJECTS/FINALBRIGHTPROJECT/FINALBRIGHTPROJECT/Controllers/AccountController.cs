        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    cuobj.FirstName = model.FirstName;
                    cuobj.LastName = model.LastName;
                    cuobj.Email = model.Email;
                    cuobj.customerCellNo = model.customerCellNo;
                    cuobj.customerAddress = model.customerAddress;


                    context.Customers.Add(cuobj);
                    context.SaveChanges();
